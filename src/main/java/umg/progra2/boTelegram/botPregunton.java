...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_2", new String[]{" 2.1", "Pregunta 2.2 cuantos años tienes?", "Pregunta 2.3"});
        preguntas.put("SECTION_3", new String[]{"Pregunta 3.1", "Pregunta 3.2", "Pregunta 3.3"});
        preguntas.put("SECTION_4", new String[]{"Pregunta 4.1- Como te sientes?", "Pregunta 4.2-Cuál es tu edad? ", "Pregunta 4.3 -Quieres que te apoye en algo??"});
    }
